...
const Pricing = () => {
    ...
    const dropdwonvalue = ["userId","id","title","body"];
    useEffect(() => {
    ...
    return (
        <div className='container'>
            <div className='row mt-3'>
                   ...
                   <div className='col-4'>
                    <select className="form-control mt-2" aria-label="Default select example" value={searchbyvalue} onChange={(e) => setSearchByvalue(e.target.value)}>
