...
const Pricing = () => {
    ...
    const SortingFun=(columnname)=>{
        alert(columnname);
         const sortingData = data;
        const result = [...filteredData].sort((a,b)=>a[columnname] < b[columnname] ? 1 : -1);
    ...
    return (
        <div className='container'>
            ...
            <table class="table mt-3">
                <thead>
                    <tr>
                        <th scope="col" onClick={()=>SortingFun("userId")}>userId</th>
                        <th scope="col" onClick={()=>SortingFun("id")}>id</th>
                        <th scope="col"  onClick={()=>SortingFun("title")} >title</th>
                        <th scope="col" onClick={()=>SortingFun("body")}>body</th>
                    </tr>
                </thead>
                <tbody>
