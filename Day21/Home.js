...
const Home = () => {
  ...
  const city =[{name:"Mumbai",key:"Mum"},{name:"Pune",key:"Pune"},{name:"Nagpur",key:"Ngp"}];
  const [cityVal,setCityVal] = useState("Ngp");
        ...
        <div className='col-4'>
          ...
          <form onSubmit={(e) => onSubmitHandler(e)}>
            ...
            <label htmlFor="exampleInputPassword1">City</label>
                    <select className="form-control mt-3" value={cityVal} onChange={(e)=>handleDropdown(e)}>
                    <option selected>Open this select menu</option>
                        {city.map((item,index)=>{
                            return (
